...
const masterActivityList = {
  ...
  3:{
    ...
    description: 'Take a five to ten minute walk',
  ...
  4:{
    ...
    description: 'Take 7 minutes to do the initial workout, follow the instructions closely. ideally in front of a mirror so you can see what your body is doing',
